 ...
 *   neptune_. For example:
 *
 *     original, found in modules/field/field.module: theme_field()
 *     theme override, found in template.php: neptune_field()
 *
 ...
 */
function neptune_preprocess_html(&$variables, $hook) {
  // Add additional body classes depending upon the layout.
  $layout = theme_get_setting('neptune_layout');
  switch ($layout) {
    case '1':
 ...
 */
function neptune_process_html_tag(&$variables) {
 ...
 */
function neptune_preprocess_page(&$variables, $hook) {
  // Retrieve the theme setting value for 'neptune_layout'.
  $layout = theme_get_setting('neptune_layout');
  ...
  // Retrieve the theme setting value for 'neptune_max_width' and construct the
  // max-width HTML.
  $max_width = theme_get_setting('neptune_max_width') . 'px';
  $variables['max_width'] = 'style="max-width:' . $max_width . '"';

  // Retrieve the theme setting value for 'neptune_display_main_menu'.
  $variables['display_main_menu'] = theme_get_setting('neptune_display_main_menu');
}
 ...
 */
function neptune_preprocess_node(&$variables, $hook) {
 ...
 */
function neptune_preprocess_comment(&$variables, $hook) {
  // Modify Zen's default pubdate output.
 ...
 */
function neptune_status_messages($variables) {
